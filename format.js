...
class Scriptable extends ToshModel {
  ...
  static newVariable(name) {
    return { name, value: 0, isPersistent: false }
  }
  static newList(listName) {
    return {
      listName,
      contents: [],
      isPersistent: false,
...
class Stage extends Scriptable {
  ...
  set costumes(xs) {
    this._costumes.data = xs.map(o => new Costume(o, this.ctx))
  }
  ...
  set sounds(xs) {
    this._sounds.data = xs.map(o => new Sound(o, this.ctx))
  }
}
...
class Project {
  ...
  static createVariable() {
    return Scriptable.newVariable()
  }
  static createList() {
    return Scriptable.newList()
  }
...
Costume.defaultBackdrop = () =>
  new Costume({
    name: "backdrop1",
    _ext: "svg",
    _file:
      "<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='480px' height='360px'><path fill='#ffffff' d='M 0 0 L 480 0 L 480 360 L 0 360 Z' /></svg>",
    bitmapResolution: 1,
    rotationCenterX: 240,
    rotationCenterY: 180,
  })
...
Costume.defaultCostume = () =>
  new Costume({
    ...
    _ext: "svg",
    _file:
      "<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='25px' height='20px'><path style='fill:#007de0;stroke:#033042;stroke-width:1;stroke-linejoin:round;' d='M 0,0 20,8 0,16 6,8 Z' /></svg>",
    bitmapResolution: 1,
    rotationCenterX: 8,
    rotationCenterY: 8,
  })
